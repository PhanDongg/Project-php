...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="os-row">
        ...
        <div class="os-col content-col">
            <div class="box">
                <?php do_action( 'phandong_before' ); ?>
                <!--code custom fields-->
                <?php
//                cách 1
//                    echo 'country : '.get_post_meta($post->ID, 'tp_country', true);
//                    
//                cách 2
                    $country = get_post_meta($post->ID, 'tp_country', true);
                    if( $country) {
                        echo 'country : '.$country;
                    }
//                cách 3: lấy dữ liệu theo dạng mảng
//                $country = get_post_meta( $post->ID );
//                var_dump( $country);
