...
function phandong() {
    echo 'insert action hook demo';
    echo '</br>';
}

add_action('phandong_before', 'phandong');

////pre_get_posts
//function phandong_pre_get_post( $query ) {
//    
//    if ( $query->is_home() && $query->is_main_query())
//        $query->set( 'orderby', 'rad');
//}
//add_action( 'pre_get_posts', 'phandong_pre_get_post' );
//
////wp head
////chèn ở trong phần head trong html dom
//function phandong_head_modify() {
//    echo "<link rel = \"author\" href=\"https://kenh14.vn\">";
//}
//add_action( 'wp_head', 'phandong_head_modify' );
//code action filters

function phandong_content_filter($content) {
    $find = 'action filters';
    $replacement = '<strong>action filters</strong>';
